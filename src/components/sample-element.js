...
class SampleElement extends connect(store)(LitElement) {
    constructor() {
        ...
        this._opened = false;
        this._openButtonHidden = false;
        this._appLanguage = "";
        this._customerLanguage = "";
        this._nameLastRomajiHidden = true;
    }
    _openButtonClicked() {
    ...
    render() {
      ...
      <style>
        ...
        [lang="en-GB"].app #date-of-birth #month-wrapper {
          order: 0;
        }

        [lang="en-US"].app #date-of-birth #month-wrapper {
          order: -1;
        }

        [lang="en-GB"].customer #date-of-birth #month-wrapper {
          order: 0 !important;
        }

        [lang="en-US"].customer #date-of-birth #month-wrapper {
          order: -1 !important;
        }
      </style>
      <button
      ...
      >
        ...
        >
          ...
          <form>
            ...
            />
            <input
              ?hidden="${this._nameLastRomajiHidden}"
              id="name-last-romaji"
              name="name-last-romaji"
...
], SampleElement.prototype, "_opened", void 0);
__decorate([
    property({ type: Boolean })
], SampleElement.prototype, "_openButtonHidden", void 0);
__decorate([
    property({ type: String })
], SampleElement.prototype, "_appLanguage", void 0);
__decorate([
    property({ type: String })
], SampleElement.prototype, "_customerLanguage", void 0);
__decorate([
    property({ type: Boolean })
], SampleElement.prototype, "_nameLastRomajiHidden", void 0);
